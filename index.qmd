...
- Housecats have super efficient kidneys, partly because they evolved from _Felis silvestris lybica_ [@Bradshaw_2013, Chapter 3].^["First, their kidneys are very efficient, as expected for an animal whose ancestors lived on the edge of deserts, and many cats drink little water, getting all the moisture they need from the meat they eat. Second, cats do not require vitamin C."]
